...
// instead.
// 
// TODO: This doesn't need to be 'any', I just don't know how to figure out
...
browser.webRequest.onBeforeRequest.addListener(listener, { urls: ["https://kernel.siasky.net/*", "https://home.siasky.net/*"] }, ["blocking"]);
...
browser.webRequest.onHeadersReceived.addListener(setResponse, { urls: ["https://kernel.siasky.net/*", "https://home.siasky.net/*"] }, ["blocking", "responseHeaders"]);
