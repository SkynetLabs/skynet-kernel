import { addContextToErr, bufToHex, defaultPortalList, error, hexToBuf, verifyRegistrySignature } from "libskynet"
...
// blob of json.
function verifyRegReadResp(response: Response, result: any, pubkey: Uint8Array, datakey: Uint8Array): error {
...
function verifyRegistryReadResponse(response: Response, pubkey: Uint8Array, datakey: Uint8Array): Promise<error> {
