import { Err, addContextToErr, bufToHex, defaultPortalList, verifyRegistryReadResponse } from "libskynet";
...
function readRegistryEntry(pubkey: Uint8Array, datakey: Uint8Array): Promise<readRegistryEntryResult> {
  return new Promise((resolve, reject) => {
    ...
    const verifyFunc = function (response: Response): Promise<Err> {
